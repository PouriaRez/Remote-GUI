...
const Sidebar = ({ pluginItems = [] }) => {
  // Plugin items are passed from Dashboard
  ...
  return (
    <nav className="sidebar">
      ...
      <NavLink to="plugins" className={({ isActive }) => isActive ? 'active' : ''}>🔌 Plugins</NavLink>
      
      {/* External Plugin Navigation */}
